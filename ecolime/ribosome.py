...
def add_ribosome(me_model, verbose=True, rRNA_mods = False):
    ...
    #print 'ribosome_assembly'
    #print ribosome_stoich
...
# TODO: Double check the modifications here
                      ...
                      # ---------16S Modifications---------------
rrna_modifications = {'m2G_at_1207': {'machine': 'RsmC_mono',  # fixed, eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      #new enzyme below #fixed 1/10/17 eddie
                      'm2G_at_1516': {'machine': 'RsmJ_MONOMER', 
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm2G_at_966': {'machine': 'RsmD_mono',  # fixed, eddie
                                     'metabolites': {'amet_c': -1,
                                                     'ahcys_c': 1,
                                                     'h_c': 1}},
                      'm3U_at_1498': {'machine': 'YggJ_dim',  # fixed, eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm4Cm_at_1402': {'machine': 'generic_16Sm4Cm1402',
                                       #RsmI and RsmH in 1:1 ratio to form this
                                       'metabolites': {'amet_c': -2,
                                                       'ahcys_c': 2,
                                                       'h_c': 2}},
                      # ref : fig 1 at http://onlinelibrary.wiley.com/doi/10.1002/wrna.79/full
                      # m44Cm does not occur in bacteria, Modomics is incorrect
                      
                      'm5C_at_1407': {'machine': 'RsmF_mono',  # fixed, eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm5C_at_967': {'machine': 'RsmB_mono',  # fixed, eddie
                                     'metabolites': {'amet_c': -1,
                                                     'ahcys_c': 1}
                                     },
                                                     #need enzyme stoich KsgA X 2
                      'm62A_at_1518': {'machine': 'KsgA_mono',  # needs two KsgA!!! Eddie, NEED TO DO
                                       'metabolites': {'amet_c': -2,
                                                       'ahcys_c': 2,
                                                       'h_c': 2}},
 #need enzyme stoich KsgA X 2
                      'm62A_at_1519': {'machine': 'KsgA_mono',  #  needs two KsgA!!! Eddie, NEED TO DO
                                       'metabolites': {'amet_c': -2,
                                                       'ahcys_c': 2,
                                                       'h_c': 2}},

#http://nar.oxfordjournals.org/content/early/2010/11/08/nar.gkq1033.full
    
            #'m1A_at_1408' : {'machine' : None, # from plasmid 'enzyme_new_NpmA', 
                  #  'metabolites' : {}},
    
  
                   
    'm7G_at_527': {'machine': 'RsmG_mono',  # fixed,eddie
                   'metabolites': {'amet_c': -1,
                                   'ahcys_c': 1,
                                   'h_c': 1}},

#https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3923132/
    # 'm7G_at_1405': {'machine': None,  # enzyme_new_RmtB from plasmid
                                #     'metabolites': {'amet_c': -1,
                                                 #    'ahcys_c': 1,
                                                 #    'h_c': 1}},
                                                     
                                                                                                    
                      'Y_at_516': {'machine': 'RsuA_mono',  # fixed, eddie
                                   'metabolites': {}},
                      ...
                      'Cm_at_2498': {'machine': 'RlmM_mono',
                                     'metabolites': {'amet_c': -1,
                                                     'ahcys_c': 1,
                                                     'h_c': 1}},
    #check what is this mod Plasmid 
                      'D_at_2449': {'machine': None,
                                    # but still unknown, the old 'DU_23S_2449'   NEED TO DO
                                    'metabolites': {'h_c': -1,
                                                    'nadh_c': -1,
                                                    'nad_c': 1}},
                      'Gm_at_2251': {'machine': 'RlmB_dim',  # fixed, eddie
                                     'metabolites': {'amet_c': -1,
                                                     'ahcys_c': 1,
                                                     'h_c': 1}},
                      ...
                      'm2A_at_2503': {'machine': 'RlmN_mono_mod_1:4fe4s',
                                      ...
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm2G_at_1835': {'machine': 'RlmG_mono',  # fixed, eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm2G_at_2445': {'machine': 'RlmL_dim',  # fixed,eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'm5C_at_1962': {'machine': 'RlmI_dim',  # fixed,eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      ...
                      'm5U_at_747': {'machine': 'RumB_mono_mod_1:4fe4s',
                                     ...
                                     'metabolites': {'amet_c': -1,
                                                     ...
                                                     'h_c': 1}},
    #new plasmid enzyme                 
                  # 'm6A_at_2058' : {'machine' : None, #enzyme_new_ErmBC from plasmid
                                  #  'metabolites' : {'ahcys_c': 1, 'amet_c': -1, 'h_c': 1}}, #new EDDIE
                                                     
                      'm6A_at_1618': {'machine': 'RlmF_mono',  # fixed,eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
#fixed, eddie 1/10/2017
                      'm6A_at_2030': {'machine': 'RlmJ_MONOMER', 
                                      # fixed, but still unknown, the old 'MeT_23S_2030' --old comment
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
#fixed, eddie  1/10/2017
                      'm7G_at_2069': {'machine': 'RlmL_dim', 
                                      # fixed, but still unknonw, the old 'MeT_23S_2069' --old comment
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'Um_at_2552': {'machine': 'RrmJ_mono',  # fixed,eddie
                                     'metabolites': {'amet_c': -1,
                                                     'ahcys_c': 1,
                                                     'h_c': 1}},
                      ...
                      'Y_at_1915': {'machine': 'RluD_mono_mod_1:mg2',
                                    # fixed,eddie
                                    'metabolites': {}},
                      'm3Y_at_1915': {'machine': 'RlmH_dim',  # fixed,eddie
                                      'metabolites': {'amet_c': -1,
                                                      'ahcys_c': 1,
                                                      'h_c': 1}},
                      'Y_at_1917': {'machine': 'RluD_mono_mod_1:mg2',
                                    # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_2457': {'machine': 'YmfC_mono',  # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_2504': {'machine': 'RluC_mono',  # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_2580': {'machine': 'RluC_mono',  # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_2604': {'machine': 'YjbC_mono',  # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_2605': {'machine': 'RluB_mono',  # fixed,eddie
                                    'metabolites': {}},
                      'Y_at_746': {'machine': 'RluA_mono',  # fixed, eddie
                                   'metabolites': {}},
                      'Y_at_955': {'machine': 'RluC_mono',  # fixed,eddie
                                   'metabolites': {}
                                  }
                                                    }
